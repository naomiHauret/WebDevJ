/*CITE THIS CODE!!!!! http://www.codeproject.com/KB/tabs/JTabbedPane.aspx?display=Print*/
import java.awt.*;
...
public class ClosableTabbedPane extends JTabbedPane{
        ...
        private static class TabCloseUI implements MouseListener, MouseMotionListener {
                ...
                private void controlCursor() {
                        if(tabbedPane.getTabCount()>0)
                                if(closeUnderMouse(meX, meY)){
                                        ...
                                        if(selectedTab > -1)
                                                tabbedPane.setToolTipTextAt(selectedTab, "Fermer " +tabbedPane.getTitleAt(selectedTab));
                                }
                                else{
        ...
        public static boolean tabAboutToClose(int tabIndex) {
                return true;
        }
